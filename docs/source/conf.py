...
# sample_pyspark_iris documentation build
...
from sample_pyspark_iris import __version__ as release

# -- Project information -----------------------------------------------------

project = "sample_pyspark_iris"
author = "Kedro"
...
htmlhelp_basename = "sample_pyspark_irisdoc"
...
latex_documents = [
    (
        master_doc,
        "sample_pyspark_iris.tex",
        "sample_pyspark_iris Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "sample_pyspark_iris",
        "Project sample_pyspark_iris codebase.",
        "Nearest-Neighbour",
    )
]
